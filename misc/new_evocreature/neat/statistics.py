...
class StatisticsReporter(BaseReporter):
    ...
    the most-fit genomes and information on genome/species fitness and species sizes.
    """
    def __init__(self): #automatically called when __init__
    ...
    def post_evaluate(self, config, population, species, best_genome):
        print("Received data in post_evaluate:")
        print("Best Genome:", best_genome)
        print("Species IDs:", species.species.keys())
        print("Fitness of Best Genome:", best_genome.fitness)
...
##                                                       k, v in iteritems(s.members))
    ...
    def get_species_sizes(self):
        ...
        print("species_counts:", all_species)

        if not all_species:
            return []  # Return an empty list if there are no species.
        ...
        return all_species, species_counts
